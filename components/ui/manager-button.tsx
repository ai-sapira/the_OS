...
// Non-button version for use inside other interactive elements (e.g., SelectTrigger)
...
const ManagerDisplay = React.forwardRef<HTMLDivElement, ManagerDisplayProps>(
  ({ name, initials, imageUrl, className, ...props }, ref) => {
    const avatarUrl = imageUrl || `https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=40&h=40&fit=crop&crop=face&auto=format&q=80`;
    ...
    return (
      <div 
        ref={ref}
        className={cn(
          "inline-flex items-center rounded-full py-0 ps-0 h-8 bg-white hover:bg-gray-50 border border-gray-200",
          className
        )}
        {...props}
      >
...
ManagerDisplay.displayName = "ManagerDisplay";

export { ManagerButton, ManagerDisplay };
