...
import { AppWindow as Apps, X, ChevronDown, ChevronUp, Check } from "lucide-react"
          ...
          <div className="flex flex-col-reverse md:flex-row">
                ...
                <div className="border-t p-6 md:border-none">
                  <div className="flex items-center space-x-3">
                    <div className="inline-flex shrink-0 items-center justify-center rounded-sm bg-muted p-3">
                      <Apps className="size-5 text-foreground" aria-hidden />
                    </div>
                    <div className="space-y-0.5">
                      <h3 className="text-sm font-medium text-foreground">Project Starter</h3>
                      <p className="text-sm text-muted-foreground">Configure your new codebase</p>
                    </div>
                  </div>
                  ...
                  <h4 className="mt-6 text-sm font-medium text-foreground">Info</h4>
                  <p className="mt-1 text-sm leading-6 text-muted-foreground">
            ...
            <div className="flex-1 space-y-6 p-6 md:px-6 md:pb-8 md:pt-6">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">Ensure code quality and consistency.</p>
                <Select defaultValue="eslint-prettier">
                  ...
                  <SelectContent>
                    <SelectItem value="eslint-prettier">ESLint + Prettier</SelectItem>
