...
const navigationItems: SearchResult[] = [
  ...
  { id: "nav-business-units", type: "navigation", title: "Business Units", subtitle: "Todas las business units", icon: <Building2 className="h-4 w-4" />, href: "/initiatives", shortcut: "G B" },
